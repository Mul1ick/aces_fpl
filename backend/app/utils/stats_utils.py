...
def calculate_breakdown(position: str, st: Any) -> Tuple[Dict, List[Dict]]:
    ...
    raw = {
        ...
        "penalties_saved": int(get("penalties_saved")), # <--- EXPLICITLY CAPTURED
    ...
    breakdown = [
        ...
        {"label": "Penalties Saved", "value": raw["penalties_saved"], "points": raw["penalties_saved"] * 5}, # <--- EXPLICITLY SHOWN
