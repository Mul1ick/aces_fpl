        ...
        <div className="lg:m-4 lg:border-2 lg:border-gray-300 lg:rounded-lg flex flex-col flex-grow">
            <div className="bg-gradient-to-b from-[#37003C] to-[#23003F] p-4 lg:rounded-t-lg">
                <GameweekHeader 
                    ...
                    view={view} 
                    setView={setView}
                    teamName={mockUserSquad.teamName}
                    managerName={mockUserSquad.managerName}
                    totalPoints={mockUserSquad.totalPoints}
                    averagePoints={mockUserSquad.averagePoints}
                    highestPoints={mockUserSquad.highestPoints}
                    gwRank={mockUserSquad.gwRank}
                    freeTransfers={mockUserSquad.freeTransfers}
                />
            </div>
            
            {view === 'pitch' ? (
                <PitchView playersByPos={playersByPos} bench={mockUserSquad.bench} onPlayerClick={setDetailedPlayer} />
            ) : (
